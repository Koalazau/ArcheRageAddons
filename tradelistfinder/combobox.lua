...
function CreateComboBox(parent, triggerWidth, triggerHeight, maxVisibleOptions, optionsData, optionHeight, triggerAnchor, triggerAnchorParent, triggerOffsetX, triggerOffsetY)
    ...
    scrollUpButton.iconOverlay:AddTexture("Addon/tradelistfinder/Icon/Up.dds")
    ...
    scrollDownButton.iconOverlay:AddTexture("Addon/tradelistfinder/Icon/Down.dds")
    ...
    for i = 0, numSliderPositions - 1 do
        ...
        sliderButton.iconOverlay:AddTexture("Addon/tradelistfinder/Icon/Scroll.dds")
