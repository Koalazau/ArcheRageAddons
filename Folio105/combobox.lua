...
function CreateComboBox(parent, triggerWidth, triggerHeight, maxVisibleOptions, optionsData, optionHeight, triggerAnchor, triggerAnchorParent, triggerOffsetX, triggerOffsetY)
    ...
    scrollUpButton.iconOverlay:AddTexture("Addon/Folio105/Icones/Up.dds")
    ...
    scrollDownButton.iconOverlay:AddTexture("Addon/Folio105/Icones/Down.dds")
    ...
    for i = 0, numSliderPositions - 1 do
        ...
        sliderButton.iconOverlay:AddTexture("Addon/Folio105/Icones/Scroll.dds")
