...
function CreateComboBox(parent, triggerWidth, triggerHeight, maxVisibleOptions, optionsData, optionHeight, triggerAnchor, triggerAnchorParent, triggerOffsetX, triggerOffsetY)
    ...
    scrollUpButton.iconOverlay:AddTexture("Addon/TreasureMapHunter/Icones/Up.dds")
    ...
    scrollDownButton.iconOverlay:AddTexture("Addon/TreasureMapHunter/Icones/Down.dds")
    ...
    for i = 0, numSliderPositions - 1 do
        ...
        sliderButton.iconOverlay:AddTexture("Addon/TreasureMapHunter/Icones/Scroll.dds")
